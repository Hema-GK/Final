...
from app.routes import marks_routes
...
# Registry maps defining core database schema states
from app.models import (
    student,
    teacher,
    timetable,
...
# Compile schema structures automatically inside database connection context
Base.metadata.create_all(bind=engine)
